package com.jaanavi.bookstore.notifications.domain;

import com.jaanavi.bookstore.notifications.ApplicationProperties;
import com.jaanavi.bookstore.notifications.domain.models.OrderCancelledEvent;
import com.jaanavi.bookstore.notifications.domain.models.OrderCreatedEvent;
import com.jaanavi.bookstore.notifications.domain.models.OrderDeliveredEvent;
import com.jaanavi.bookstore.notifications.domain.models.OrderErrorEvent;
...
// we are not using any email service provider gmail/yahoo
// ,we are using utility called mailhog(local developmetn or testing) docker image is composed in infra and run to
// create docker container
// runs and available for us
@Service
