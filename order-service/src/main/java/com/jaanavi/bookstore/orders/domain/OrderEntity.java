...
@Table(name ="orders")
 class OrderEntity {
    ...
    //instend of using single property using it as below,for mapping name value into that column value
    @Embedded //from hibernate 6.2
    @AttributeOverrides(
            value = {
    ...
    private Address deliveryAddress; //we can also have billing address
