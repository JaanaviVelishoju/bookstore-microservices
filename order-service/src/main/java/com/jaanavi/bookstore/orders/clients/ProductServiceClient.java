...
public class ProductServiceClient {
    ...
    public ProductServiceClient(RestClient restClient) {
        this.restClient = restClient; // will hold url of catalog service
    }
    ...
    // if after retry it still fails ,then this fallback method is called ,
    // logic is implemented acc. to business requirement , we can do caching by using redis,and cached value is
    // comapred,
    // and proceed with order. ,to not to distrub the customers
