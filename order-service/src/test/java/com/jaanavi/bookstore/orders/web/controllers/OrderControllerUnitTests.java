...
import com.jaanavi.bookstore.orders.domain.SecurityService;
import com.jaanavi.bookstore.orders.domain.OrderService;
import com.jaanavi.bookstore.orders.domain.models.CreateOrderRequest;
import org.springframework.test.context.bean.override.mockito.MockitoBean;

import static com.jaanavi.bookstore.orders.testdata.TestDataFactory.*;
...
@WebMvcTest(OrderController.class) //slice test testing web layer
public class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        //as we are mocking securityService that doesnot return anything we need to assign value
...
//                        .with(csrf())
    ...
    //provides dummy data for testing our webmvc layer by using instancio denependency in testDataFactory where all 3 tests are done at a time
